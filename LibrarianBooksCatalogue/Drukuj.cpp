		...
		if(db.open())
		{
			...
			if (id !=0)
			{
                ...
                if (ok)
                {
                    ...
                    fnout << tr("Oryginalny tytuł") << QString::fromWCharArray(L"</p></td><td>");
                    ...
                    fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
                    fnout << tr("Ilość") << QString::fromWCharArray(L"</p></td><td>");
                    ...
                    fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
                    fnout << tr("Język wydania") << QString::fromWCharArray(L"</p></td><td>");
                    ...
                    fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
                    fnout << tr("Właściciel - Imię i nazwisko") << QString::fromWCharArray(L"</p></td><td>");
                    fnout << QString(query.value(WL_Im_Nazw_Col).toString());
                    fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
                    fnout << tr("Właściciel - Adres") << QString::fromWCharArray(L"</p></td><td>");
                    ...
                    fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
                    fnout << tr("Ilość stron") << QString::fromWCharArray(L"</p></td><td>");
                    ...
                    fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
                    fnout << tr("Ocena książki") << QString::fromWCharArray(L"</p></td><td>");
					...
					if (ui.checkBox_AUTHORS->isChecked())
					{
						...
						if (ok) 
						{
							...
							while (query2.next())
							{
								...
								fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
								fnout << tr("Narodowość") << QString::fromWCharArray(L"</p></td><td>");
								fnout << QString(query2.value(narodCol).toString());
								fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
								fnout << tr("Specjalność") << QString::fromWCharArray(L"</p></td><td>");
								fnout << QString(query2.value(specCol).toString());
								fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
								fnout << tr("Napisane rozdziały") << QString::fromWCharArray(L"</p></td><td>");
					...
					if (ui.checkBox_BORROWS->isChecked())
					{
						...
						if (ok)
						{
							...
							{		
								...
								fnout << QString::fromWCharArray(L"</h1><table ><tr><td><p>");
								fnout << tr("Osoba wypożyczająca") << QString::fromWCharArray(L"</p></td><td>");
								fnout << QString(query4.value(osobaCol).toString());
								fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
								fnout << tr("Data wypożyczenia") << QString::fromWCharArray(L"</p></td><td>");
								...
								fnout << QString::fromWCharArray(L"</td></tr><tr><td><p>");
								fnout << tr("Stan przed wypożyczeniem") << QString::fromWCharArray(L"</p></td><td>");

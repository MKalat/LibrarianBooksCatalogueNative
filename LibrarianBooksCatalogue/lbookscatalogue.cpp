...
void LBooksCatalogue::BTN_SAVE_CLICKED()
{
	...
	{
		AddNewRec(0);
		new_rec_adding = false; // po zakończonych dodaniach wyczyść status dodawania nowego rekordu
...
{
	//TODO: Napisać odczytwyanie ustawień aplikacji
...
if(db.open())
{
			...
			db.close();
				...
				//UpdateDB(cur_id); // update-uj tabele podrzędne
...
{
	//TODO: napisac zapisywanie ustawień aplikacji
...
{
	//TODO: Napisać tworzenie domyślnej konfiguracji i zapsiawanie jej na dysk
